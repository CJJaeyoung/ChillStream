...
- 구독 기반의 비즈니스 모델을 채택하고 있으며, 사용자들이 다양한 영화, 비디오 콘텐츠를 시청하고 댓글을 통해 소통할 수 있는 환경을 제공
...
# 광고 재생과 이어서 시청하기 기능 충돌 해결 및 정상화
...
## ⚠️ 원인
-광고 종료 함수가 완전히 작동하기 전에 이어보기 함수가 호출되어 충돌이 발생한 것이라 짐작

-조사 결과 이는 '이어보기' 함수의 비동기 처리로 인한 경합 상태(race condition)
