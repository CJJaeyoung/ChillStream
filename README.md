...
|팀원명   |포지션   | 담당   |깃허브 링크|
|---| ---   |---|---|
|현영민|   팀장|콘텐츠 관리 기능<br>영상 상세보기 기능<br>영상 및 광고 관리 기능<br>댓글 관리 및 무한 스크롤 기능<br>이어서 시청하기 및 자막 기능    | https://github.com/soy9 |
...
### CI/CD
- **GitHub** : 코드 버전 관리와 협업을 효율적으로 진행하기 위해 사용하였으며, 분산형 버전 관리 시스템을 통해 여러 개발자가 동시에 작업할 수 있도록 하여 개발 속도와 품질을 높였다.
